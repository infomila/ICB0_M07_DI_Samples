...
CREATE TABLE DEPT (
 DEPT_NO  NUMERIC(2) CONSTRAINT DEPT_PK PRIMARY KEY
...
CREATE TABLE EMP (
 ...
 OFICI     VARCHAR(10),
 CAP       NUMERIC(4) CONSTRAINT EMP_FK_EMP REFERENCES EMP,
 DATA_ALTA DATETIME,
 SALARI    NUMERIC(10) CONSTRAINT EMP_CK_SALARI CHECK (SALARI >=0),
 COMISSIO  NUMERIC(10) CONSTRAINT EMP_CK_COMISSIO CHECK (COMISSIO >= 0),
 DEPT_NO   NUMERIC(2) CONSTRAINT EMP_NN_DEPT_NO NOT NULL 
...
CREATE TABLE CLIENT (
 CLIENT_COD          NUMERIC(6),
 NOM                 VARCHAR (45) CONSTRAINT CLIENT_NN_NOM NOT NULL,
 DIRECCIO            VARCHAR (40) CONSTRAINT CLIENT_NN_DIRECCIO NOT NULL,
 CIUTAT              VARCHAR (30) CONSTRAINT CLIENT_NN_CIUTAT NOT NULL,
 ESTAT               VARCHAR (2),
 CODI_POSTAL         VARCHAR (9) CONSTRAINT CLIENT_NN_CODI_POSTAL NOT NULL,
 AREA                NUMERIC(3),
 TELEFON             VARCHAR (9),
 REPR_COD            NUMERIC(4) CONSTRAINT CLIENT_FK_EMP REFERENCES EMP,
 LIMIT_CREDIT        NUMERIC(9,2) CONSTRAINT CLIENT_CK_LIMIT_CREDIT CHECK (LIMIT_CREDIT>=0),
...
CREATE TABLE PRODUCTE (
 PROD_NUM     NUMERIC(6) CONSTRAINT PRODUCTE_PK PRIMARY KEY
                         CONSTRAINT PRODUCTE_CK_COD_POSITIU CHECK (PROD_NUM > 0),
 DESCRIPCIO   VARCHAR (30) CONSTRAINT PRODUCTE_NN_DESCRIPCIO NOT NULL CONSTRAINT PRODUCTE_UN_DESCRIPCIO UNIQUE);
...
CREATE TABLE COMANDA  (
 COM_NUM             NUMERIC(4),
 COM_DATA            DATETIME,
 COM_TIPUS           VARCHAR (1) CONSTRAINT COMANDA_CK CHECK (COM_TIPUS IN ('A','B','C')),
 CLIENT_COD          NUMERIC(6) CONSTRAINT COMANDA_NN_CLIENT NOT NULL,
 DATA_TRAMESA        DATETIME,
 TOTAL               NUMERIC(8,2) CONSTRAINT COMANDA_CK_TOTAL_NO_NEGATIU CHECK (TOTAL >= 0),
...
CREATE TABLE DETALL  (
 ...
 PROD_NUM            NUMERIC(6) CONSTRAINT DETALL_NN_PRODUCTE NOT NULL,
 ...
 CONSTRAINT DETALL_CK_DETALL_NUM_POSITIU CHECK (DETALL_NUM > 0),
 CONSTRAINT DETALL_CK_PVP_NO_NEGATIU CHECK (PREU_VENDA >= 0));
